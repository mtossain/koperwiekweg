...
while True:
    ...
    os.system("avconv -rtsp_transport tcp -y -i rtsp://admin:123456@192.168.178.254:554/mpeg4 -vcodec copy -t 1 "+snapshot+".mp4")
    os.system("avconv -ss 00:00:00.5 -t 1 -y -i "+snapshot+".mp4 -f mjpeg "+snapshot+".jpeg")
