...
# Wunderground needs some very special values... non SI units
...
temp = 23.4 # temp outside
ground_temp = 16.345 # soil temp
humidity = 55.998 # rel humidity
pressure = 1067.890 # hpa
...
temp_str = "{0:.2f}".format(degc_to_degf(temp))
